...
const getBrowserCanvas = (width, height) => {
...
const getNodeCanvas = (width, height) => {
...
const getPathMatrix = (path, width, height, cropBox) => {
  const canvas = typeof document !== 'undefined' ? getBrowserCanvas(width, height) : getNodeCanvas(width, height);
